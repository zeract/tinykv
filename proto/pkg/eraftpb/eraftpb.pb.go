...
const (
	...
	// 'MessageType_MsgPreRequestVote' requests Prevotes for election
	MessageType_MsgPreRequestVote MessageType = 13
	// 'MessageType_MsgPreRequestVoteResponse' contains responses from Prevoting request.
	MessageType_MsgPreRequestVoteResponse MessageType = 14
)
...
var MessageType_name = map[int32]string{
	...
	12: "MsgTimeoutNow",
	13: "MsgPreRequestVote",
	14: "MsgPreRequestVoteResponse",
}
...
var MessageType_value = map[string]int32{
	...
	"MsgTimeoutNow":             12,
	"MsgPreRequestVote":         13,
	"MsgPreRequestVoteResponse": 14,
}
...
type Message struct {
	...
	Xterm                uint64      `protobuf:"varint,11,opt,name=xterm,proto3" json:"xterm,omitempty"`
	Xindex               uint64      `protobuf:"varint,12,opt,name=xindex,proto3" json:"xindex,omitempty"`
	Xlen                 uint64      `protobuf:"varint,13,opt,name=xlen,proto3" json:"xlen,omitempty"`
...
func (m *Message) GetXterm() uint64 {
	if m != nil {
		return m.Xterm
	}
	return 0
...
func (m *Message) GetXindex() uint64 {
	if m != nil {
		return m.Xindex
	}
	return 0
...
var fileDescriptor_acd9f78e51523dd8 = []byte{
	...
	,
}
